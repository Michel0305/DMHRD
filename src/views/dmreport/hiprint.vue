<template>
<div class="print_template_container" :style="{height:$store.getters.locheight - 110+'px' }">
    <el-container class="print_template_main" style="height: 100vh;">
        <el-aside width="240px">
            ...
            <el-row class="drag_item_title">模板</el-row>
            <el-row :gutter="10">
                <el-col :span="24">
                    <el-table :data="tableData" border style="width: 100%" :max-height="$store.getters.locheight - 470">
                        <el-table-column prop="date" label="模板名" width="100">
                        </el-table-column>
        ...
        <el-container>
                ...
                <el-row style="height: 100%">
                    <el-col :span="24" style="height: 100%">
                        <el-button-group>
							...
							<el-button :type="currentPaperType === 'DMGZ' ? 'primary' : 'info'" @click="setPaper('DMGZ')">DMGZ</el-button>
                        </el-button-group>
                        ...
                        <el-button-group>
                            ...
                            <el-button type="info" icon="el-icon-document" @click="getJson()">保存模板</el-button>
                            <el-button v-if="1==2" type="info" icon="el-icon-tickets" @click="getHtml(printData)">预览HTML</el-button>
                        </el-button-group>
                        <el-button-group>
                            <el-button type="info" icon="el-icon-full-screen" v-if="!fullDialogStatus" @click="fullDialogStatus = true">全屏</el-button>
                            <el-button type="info" icon="el-icon-full-screen" v-if="fullDialogStatus" @click="fullDialogStatus = false">正常屏幕</el-button>
                        </el-button-group>
                        <el-button-group>
            ...
            <el-main>
                <el-row>
                    <el-col style="padding: 20px" :span="18" id="hiprint-printTemplate" class="hiprint-printTemplate"></el-col>
                ...
                <el-drawer size="100%" class="params_drawer" :title="paramsDrawerTitle" :modal="false" :wrapperClosable="true" @opened="handleParamsOpened" :visible.sync="paramsDrawerStatus" direction="rtl">
    ...
    <el-dialog class="preview_dialog" ref="previewDialog" title="快速预览" @opened="handlePreviewOpened(printData)" :width="currentPaper.width * 1 + 'mm'" :visible.sync="previewDialogStatus">
    ...
    <el-dialog ref="infoDialog" :title="infoDialogTitle" :lock-scroll="true" :visible.sync="infoDialogStatus">
        <el-input type="textarea" :readonly="true" :autosize="{ minRows: 15}" placeholder="请输入内容" v-model="infoTextarea"></el-input>
        <span slot="footer" class="dialog-footer">
            ...
            <el-table-column label="远程数据源">
                <template slot-scope="scope">
                    <el-select :value="scope.row.options.field" placeholder="请选择">
                        <el-option :label="'名称数据'" :value="'name'">
                        </el-option>
                        <el-option :label="'描述数据'" :value="'desc'">
                        </el-option>
                    </el-select>
                </template>
            </el-table-column>
    ...
    <el-dialog class="full_screen_dialog" :show-close="false" :visible.sync="fullDialogStatus" :modal="false" @opened="openFullScreen" @close="closeFullScreen" :fullscreen="true">
...
export default {
    ...
    methods: {
        ...
        printTemplate(printData) {            
            hiprintTemplate.print(printData,{ paperNumberToggleInEven:false });
        },
        /**
         * @Author: TangLiangcheng
    ...
    mounted() {
        ...
        $(document).ready(() => {
            ...
            let gzmb = require('./modeltemplate/gz')
            let _customPrintJson = gzmb[0]
            hiprintTemplate = new hiprint.PrintTemplate({
            ...
            self.setCurrentPaper(self.paperMap.DMGZ);
		...
		this.printData = {
                ...
                reworkDay: '22',
                leaveDay: '0',
                pacificOverWork: '20.0',
                weekOverWork: '30.5',
                holidayOverWork: '75',
                allOverWork: '57.5',
                otherCharges: '1500.0',
                seniorityPay: '240.0',
                attendanceBonus: '100.0',
                mealSubsidy: '0.0',
                bonus: '2000.0',
                kpi: '0.0',
                pacificOverTimePay: '560.0',
                weekOverTimePay: '915.0',
                holidayOverTimePay: '375.0',
                isSalary: '10210.38',
                social: '315.8',
                accumulation: '512.5',
                frock: '80.0',
                ...
                individual: '12.35',
                other: '30.6',
                accruingAmounts: '976.55',
                realWages: '9233.83',
                accountMonth: '2021-05',
                dempartment: 'IT(开发组)',
                fullname: '项敏'
            }
    }
