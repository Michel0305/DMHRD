...
<div class="department-container">
    <el-row>
        <el-col :span="18" :offset="2">
            <el-table max-height="300" :data="departmentData" style="width: 100%" @row-click="openDetails" highlight-current-row>
                ...
                <el-table-column label="编制人数" prop="authorized"> </el-table-column>
    ...
    <el-row>
        <el-col :span="18" :offset="2">
            <el-table :max-height="contentStyleObj.height" :data="jobData.filter(data=> !swhere || data.defpartid===swhere) " style="width: 100%">
...
export default {
    ...
    methods: {
        ...
        getHeight() {
            //此处代码需要优化 全局使用
            this.contentStyleObj.height = window.innerHeight - 500;
        },
    },
    destroyed() {
