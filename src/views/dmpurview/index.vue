...
<div class="purview-container">
    ...
    <el-row :gutter="2">
        <el-col :span="20" :offset="2">
            <el-table ref="userData" :data="$store.getters.departmentjob_personals.filter((data)=>!swhere ||
                data.user_name.toLowerCase().includes(swhere.toLowerCase()) ) " height="230" border highlight-current-row style="width: 100%" @cell-click="setRow">
    ...
    <el-row :gutter="10">
        ...
        <el-col :span="4" :offset="1">
            <el-table ref="mTableModels" :data="modelData" border tooltip-effect="dark" style="width: 100%" :max-height="$store.getters.locheight - 200" @selection-change="SelectionChangeModels" @cell-click="setRowActive">
        ...
        <el-col :span="6" :offset="1">
            <el-table ref="dTableDepart" :data="$store.getters.departmentjob_departs" border tooltip-effect="dark" style="width: 100%" :max-height="$store.getters.locheight - 200" @selection-change="SelectionChangeDepart">
                <el-table-column type="selection" width="40" :selectable="checkRoleboxSelect" />
            ...
            this.$nextTick(() => {
                this.RolesToModels.forEach((vls, key) => {
                    if (row.id == vls.roleid) {
                        let tmpModelData = this.modelData.find(els => { return els.id == vls.modelid })
