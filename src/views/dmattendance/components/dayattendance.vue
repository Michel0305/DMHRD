...
<div class="app-container-reissue">
                        ...
                        : ""
                            ...
                            <el-table-column align="right" width="120">
                                <template slot-scope="scope">
                                    ...
                                    <el-button size="mini" type="success" icon="el-icon-medal" @click="passCard(scope.$index, scope.row)"></el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                    </el-col>
    ...
    <el-dialog title="过滤此人员异常" :visible.sync="dialogVisible" width="30%">
        ...
        <span slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="changeCardStatus" size="mini">确 定</el-button>
        </span>
    </el-dialog>
</div>
</template>
